...
**Referências ao livro.** O título *AI Engineering: Building Applications with
Foundation Models* permanece em inglês por ser o nome comercial da obra.

---

## 5. Escopo

Traduz-se o **material de apoio** publicado abertamente no repositório do livro:
sumário, resumos de capítulo, notas de estudo, listas de recursos, exemplos de prompt,
estudos de caso e apêndice. O texto do livro não está neste repositório e não é objeto
desta tradução.

Nos notebooks, apenas células markdown e comentários são traduzidos. Células de código,
saídas de execução e metadados permanecem byte a byte idênticos ao original.
